...
module.exports = {
    ...
    create: function (req, res) {
        var Patient = new PatientModel({
			...
			patientgroupid : req.body.patientgroupid,
			medicalhistoryids : req.body.medicalhistoryids,
			otherhistory : req.body.otherhistory,
			...
			referraldescription : req.body.referraldescription,
